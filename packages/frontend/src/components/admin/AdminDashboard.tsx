      ...
      <div className="bg-white overflow-hidden shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">
            Welcome to THETA EuroCon Admin Portal
          </h2>
          <p className="text-gray-600 mb-6">
            Manage registrations, check-ins, and event operations from this central dashboard.
          </p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-800">
                  <strong>Quick Actions:</strong> Use the "Manage Tickets" button above to view and manage all registrations.
                </p>
              </div>
            </div>
          </div>
